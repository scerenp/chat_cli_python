...
class RegisterBot(sleekxmpp.ClientXMPP):
    def __init__(self, jid, password):
        sleekxmpp.ClientXMPP.__init__(self, jid, password)   #Nos conectamos con el cliente con el jid y el password que le pasamos
    ...
    def register(self, iq):
        resp = self.Iq()
        resp['type'] = 'set'
        resp['register']['username'] = self.boundjid.user  #Cuando nos conectamos, podemos acceder a nuestro usuario con: boundjid.user
...
if __name__=='__main__':
    ...
    #usuario = 'saucer@alumchat.xyz'  #Nombre de usuario o jid
